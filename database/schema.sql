...
('Harbour Light Walk','Arts & Culture',DATE_ADD(CURRENT_DATE, INTERVAL 30 DAY),'18:30','Barangaroo Reserve, Sydney',350,24.00,'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=1200&q=80','Follow an illuminated waterfront trail featuring independent NSW artists, live projection works and relaxed food stations. The route includes step-free access, rest points and clearly marked quiet viewing areas.','published',NULL),
('Hunter Harvest Table','Food & Wine',DATE_ADD(CURRENT_DATE, INTERVAL 45 DAY),'12:00','Pokolbin Community Grounds, Hunter Valley',180,89.00,'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=1200&q=80','Share a long-table lunch celebrating Hunter growers, winemakers and chefs. Your ticket includes seasonal courses, alcohol-free pairings and producer conversations in a shaded outdoor setting.','published',NULL),
('Coastal Roots Live','Music',DATE_ADD(CURRENT_DATE, INTERVAL 60 DAY),'15:00','North Byron Parklands, Byron Bay',1200,72.50,'https://images.unsplash.com/photo-1506157786151-b8491531f063?auto=format&fit=crop&w=1200&q=80','An afternoon-to-evening program of Australian roots, soul and contemporary acts across two accessible stages, with local food vendors, water refill points and a dedicated low-sensory zone.','published',NULL),
('Future Work NSW Forum','Business',DATE_ADD(CURRENT_DATE, INTERVAL 75 DAY),'09:00','International Convention Centre, Sydney',500,145.00,'https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=1200&q=80','A practical one-day forum for NSW leaders exploring responsible AI, adaptable teams and inclusive workplaces through keynotes, small workshops and structured networking sessions.','published',NULL),
('Blue Mountains Family Discovery Day','Community',DATE_ADD(CURRENT_DATE, INTERVAL 90 DAY),'10:00','Wentworth Falls Picnic Area, Blue Mountains',220,0.00,'https://images.unsplash.com/photo-1500534314209-a25ddb2bd4297?auto=format&fit=crop&w=1200&q=80','A free family program of guided nature walks, creative workshops and local storytelling. Sessions include accessible options and advance information about terrain, distance and available support.','published',NULL);
